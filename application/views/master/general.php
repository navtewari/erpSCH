                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchLogoEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'file',
                                                'class' => "span4",
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $sch->SCH_NAME; ?>                                        
                                        <div class="controls txtSchNameEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'autocomplete' => 'off',
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $sch->SCH_CONTACT; ?>                                     
                                        <div class="controls txtSchContactEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'autocomplete' => 'off',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchEmailEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'email',
                                                'autocomplete' => 'off',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchAddEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'autocomplete' => 'off',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchCityEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'class' => "span11",
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchDisittEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'class' => "span11",
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchStateEdit">                        
                                            <?php
                                            $data = array(
                                                'name' => 'cmbPState',
                                                'id' => 'cmbPState',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls txtSchCountryEdit" style="display:none;">                        
                                            <?php
                                            $data = array(
                                                'type' => 'text',
                                                'class' => "span11",
