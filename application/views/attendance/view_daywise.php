...
<div class="row-fluid">
    <?php
        $attrib_ = array(
            'class' => 'form-vertical',
            'name' => 'frmViewDaywiseAttendance',
            'id' => 'frmViewDaywiseAttendance',
        );
        ...
        <div class="widget-box">
            ...
            <div class="widget-content" style="overflow: hidden">
	            ...
	            <div class="control-group span3">
	                <label class="control-label"> For Date <span style="font-size: 9px">(dd/mm/yyyy)</span></label>
                    <div class="controls">
		...
		<div class="widget-box" id="printTable">
		    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
		        ...
		        <h5 style="float:right;" class="hide_print">
		        	<a href="#" class="print_btn" onclick="printData();" id="my_print_btn">Print</a>
		    	</h5>
		        <h5 style="float: right" id="total_students"></h5>
		    </div>
		    <div class="widget-content nopadding" id="view_day_wise_attendance">
		    </div>
		</div>
</div>