...
<html lang="en">
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="<?php echo site_url().'/web/dashboard';?>">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="<?php echo site_url().'/web/dashboard';?>" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
